            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-xs space-y-4">
                <h3 className="font-bold text-slate-900 flex items-center gap-2 text-sm">
                  ...
                  3. Gam Màu Điểm Nhấn (Accent Color)
                </h3>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  {accentColors.map((color) => (
                    <button
                      key={color.value}
                      type="button"
                      onClick={() => setLocalBranding({ ...localBranding, primaryAccent: color.value, accentName: color.name })}
                      className={`flex items-center gap-2 px-3 py-2 rounded-xl border transition cursor-pointer ${
                        localBranding.primaryAccent === color.value
                          ? 'bg-blue-50 border-blue-600 text-blue-900 font-bold shadow-xs'
                          : 'bg-white border-gray-200 text-slate-600 hover:bg-gray-50'
                      }`}
                    >
                      <span className="w-4 h-4 rounded-full shadow-xs" style={{ backgroundColor: color.value }}></span>
